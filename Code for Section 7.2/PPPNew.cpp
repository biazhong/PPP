...
/**
method used to generate observations for the three-stage buffere allocation problem
**/
...
int main(int argc, char** argv){
    ...
    while(_survivingK > world_size - 1 && t <= maxN){
	    ...
	    for(int i = 1; i < _record_surviving.size();i++){
                if(I[_record_surviving[i]].sampleXSum + h2 * I[_record_surviving[i]].S2 < I[_record_surviving[0]].sampleXSum - h2 * I[_record_surviving[0]].S2+lambda * I[_record_surviving[0]].sampleSize){
